!(function (e) {
  ...
  (window.onpageshow = function (e) {
    ...
    e(window).on("load", function () {
      ...
      e("#contactMeBtn").on('click', function (ev){
        console.log('dfd');
        ev.preventDefault();
        e("body, html").animate({ scrollTop: e("#section-contacts").offset().top - 68 }, 400);
      })
      ...
      0 == n.indexOf("#section-") &&
        t.length &&
        e("body, html").animate({ scrollTop: e(n).offset().top - 68 }, 400);
    });
  var a = e(window).width(),
    n = e(window).height();
  if (
    (a < 783 && e(".section.started").css({ height: n }),
    ...
    t.on("slideChange", function () {
      ...
      e(".started-carousel .swiper-slide").removeClass("first"),
        e(".started-carousel .swiper-slide").each(function (n, t) {
          a - 1 >= n
            ? e(t).addClass("swiper-clip-active")
            : e(t).removeClass("swiper-clip-active");
        }),
    ...
    e("header .top-menu").on("click", "a", function () {
      ...
      if (0 == a.indexOf("#section-"))
        e("body").hasClass("home") || (location.href = "/" + a),
          e("body, html").animate({ scrollTop: e(a).offset().top - 115 }, 400),
  ...
  s.imagesLoaded(function () {
    ...
    setTimeout(function () {
      ...
      a.length &&
        ...
        a.find(".percentage .da").css({ width: n }));
    }, 1e3);
    ...
    e("#cform").validate({
      ...
      submitHandler: function () {
        e.ajax({
          ...
          type: "post",
          dataType: "json",
          data: "MODE=contact&" + e("#cform").serialize(),
          complete: function (result) {
            let { Status } = JSON.parse(result.responseText);
            if(Status == "Success"){
                e("#cform").fadeOut(), e(".alert-success").delay(1e3).fadeIn(), e(".alert-success").delay(1e3).fadeOut(), e("#cform").delay(2000).fadeIn();
                e("#cform")[0].reset();
              }else{
                e("#cform").fadeOut(), e(".alert-error").delay(1e3).fadeIn(), e(".alert-error").delay(1e3).fadeOut(), e("#cform").delay(2000).fadeIn();  
            }
          },
        });
      },
